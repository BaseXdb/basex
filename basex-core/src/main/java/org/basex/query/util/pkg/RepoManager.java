...
public final class RepoManager {
  ...
  private boolean installXQ(final byte[] cont, final String path)
    ...
    final IOFile rp = new IOFile(ctx.globalopts.string(GlobalOptions.REPOPATH));
