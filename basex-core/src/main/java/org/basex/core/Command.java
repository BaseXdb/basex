...
public abstract class Command extends Proc {
  ...
  /**
   * Runs the command without permission, data and concurrency checks. Should be called with care,
   * and only by other database commands.
   * @param ctx database context
  ...
  /**
   * Returns a cached result set generated by {@link AQuery#query}. Will only yield results if
   ...
   * {@link Context#data()} reference. This method is required by the progress dialog in the
   * frontend.
   * @param ctx database context
   * @return result of check
   */
  ...
  /**
   * Returns true if this command returns a progress value. This method is required by the progress
  ...
  /**
   * Returns true if this command can be stopped. This method is required by the progress dialog in
   * the frontend.
   * @return result of check
   */
