...
public final class FnModuleTest extends QueryPlanTest {
  ...
  @Test public void replace() {
    ...
    query(func.args("aaaa bbbbbbbb ddd ", "\"(.{6,15}) \"", "\"$1@\""), "aaaa bbbbbbbb@ddd ");
    query(func.args("\" aaa AAA 123\"", "\"(\\s+\\P{Ll}{3,280}?)\"", "\"$1@\""), " aaa AAA@ 123@");
  ...
  @Test public void sum() {
    ...
    query(func.args(" 1 to 3037000499"), "4611686016981624750");
    query(func.args(" 1 to 3037000500"), "4611686020018625250");
    query(func.args(" 1 to 4294967295"), "9223372034707292160");
