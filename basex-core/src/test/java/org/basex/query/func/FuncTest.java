...
public final class FuncTest extends QueryTest {
  ...
  static {
    ...
    queries = new Object[][] {
      { "sum 1", integers(1), "sum(1)" },
      { "sum 2", integers(55), "sum(1 to 10)" },
      { "sum 3", integers(4611686016981624750L), "sum(1 to 3037000499)" },
      { "sum 4", integers(4611686020018625250L), "sum(1 to 3037000500)" },
      { "sum 5", integers(9223372034707292160L), "sum(1 to 4294967295)" },

      { "distinct-values 1", integers(2), "count(distinct-values(//line/text()))" },
    };
  }
