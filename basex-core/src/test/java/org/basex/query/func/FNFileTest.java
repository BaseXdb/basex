...
public final class FNFileTest extends AdvancedQueryTest {
  ...
  public void writeText() {
    ...
    error(_FILE_WRITE_TEXT.args(PATH1, " 123"), Err.INVCASTEX);
  ...
  public void writeTextLines() {
    ...
    error(_FILE_WRITE_TEXT_LINES.args(PATH1, " 123"), Err.INVCASTEX);
  ...
  public void appendText() {
    ...
    error(_FILE_APPEND_TEXT.args(PATH1, " 123"), Err.INVCASTEX);
  ...
  public void appendTextLines() {
    ...
    error(_FILE_APPEND_TEXT_LINES.args(PATH1, " 123"), Err.INVCASTEX);
