...
public final class FTTest extends QueryTest {
  ...
  public static final Object[][] QUERIES = {
      ...
      { "FT 2", node(14), "//w[text() contains text 'hello']" },
      { "FT 3", node(14), "//w[text() contains text '    hello!...   ']" },
      { "FT 4", empty(), "//w[  text  (   )  contains text  '  crap  '  ]  " },
      { "FT 5", empty(), "//w[text() contains text 'db']" },
      { "FT 6", node(42, 46), "//mix[text() contains text 'A']" },
      { "FT 7", node(14), "//w[text() contains text 'hello']['A' contains text 'A']" },
      { "FT 8", node(14), "//w[text() contains text 'hello']['X' contains text 'X' using fuzzy]" },
      { "FT 9", node(14), "//w[text() = 'hello' and 'X' contains text 'X']" },
      { "FT 10", node(14), "//w[text() = 'hello' and text() contains text 'hello']" },
      { "FT 11", empty(), "//wld[text() contains text '']" },
      { "FT 12", empty(), "//wld[text() contains text ' ']" },
      { "FT 13", node(40), "//*[text() contains text 'yeah']" },
      ...
      { "FTWildCard 16", bool(false), "'a' contains text 'a.+' using wildcards" },
      { "FTWildCard 17", bool(true), "'aa' contains text 'a.+' using wildcards" },
      { "FTWildCard 18", bool(true), "'aaaa' contains text 'a.+' using wildcards" },
      { "FTWildCard 19", bool(true), "'a' contains text 'a.*' using wildcards" },
      { "FTWildCard 20", bool(true), "'aaaaaa' contains text 'a.*' using wildcards" },
      { "FTWildCard 21", bool(false), "'a' contains text 'a.' using wildcards" },
      { "FTWildCard 22", bool(true), "'aa' contains text 'a.' using wildcards" },
      { "FTWildCard 23", bool(true), "'a' contains text 'a.{0,1}' using wildcards" },
      { "FTWildCard 24", bool(true), "'aa' contains text 'a.{0,1}' using wildcards" },
      ...
      { "FTWildCard 29", bool(true), "'hi' contains text '\\h\\i' using wildcards" },
      // #660: combination of FTAnyAllOption and wildcards
      { "FTWildCard 30", bool(true),
        "'a' contains text '.*' all words using wildcards" },

      { "FTFuzzy 1", node(7, 9, 11), "//*[text() contains text 'Database' using fuzzy]" },
      { "FTFuzzy 2", node(7, 9, 11), "//*[text() contains text 'Databaze' using fuzzy]" },
      ...
      { "FTStopWords 1", node(7, 9, 11), "//*[text() contains text " +
