...
public final class DocTest extends QueryTest {
  static {
    ...
    queries = new Object[][] {
      ...
      { "PredIndex 7", emptySequence(), "//@id[. = '#000000']" },
      ...
      { "PosPred 5", emptySequence(), "//li[2][2]" },
      { "PosPred 6", nodes(8, 15, 19, 22), "//*[.[1]][2]" },
      { "PosPred 7", nodes(1, 3, 5, 13, 17, 20), "//*[.[1]][1]" },
      { "PosPred 8", emptySequence(), "//*[1.1]" },
      { "PosPred 9", nodes(8, 15, 19, 22), "//*[position() > 1.1]" },
      { "PosPred A", emptySequence(), "//*[position() <= 0.9]" },
      { "PosPred B", emptySequence(), "//li[last()][contains(text(), '1')]" },
      ...
      { "Index 7", emptySequence(), "//*[text() = 'XM' and text()]" },
