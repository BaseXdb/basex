...
public final class UpdateTestDeletes extends UpdateTest {
  ...
  public void testSimpleNodeDelete() {
    ...
    assertByteArraysEqual(token("parentnode"), data.name(3, true));
  ...
  public void testCascadingDelete() {
    ...
    assertByteArraysEqual(token("parentnode"), data.name(2, true));
  ...
  public void testCascadingDelete2() {
    ...
    assertByteArraysEqual(token("b"),         data.name(6, true));
  ...
  public void testDeleteAttribute() {
    ...
    data.delete(7);
    assertEquals(size - 1, data.meta.size);
    assertByteArraysEqual(token("contextnode"), data.name(6, true));
    assertByteArraysEqual(token("id"), data.name(7, false));
    assertEquals(oldRootSize - 1, data.size(1, Data.ELEM));
