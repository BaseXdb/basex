 ...
 */
public final class XQFTTS {
  // Try "ulimit -n 65536" if Linux tells you "Too many open files."
  
  /** History Path. */
  private static final String PATHHIST = "xqftts.hist";
  /** Log File. */
  private static final String PATHLOG = "xqftts.log";
  ...
  private String tests = ROOT + "home/db/xml/xqftts/";
  /** Query Path. */
   ...
   * @throws Exception exception
   */
  private XQFTTS(final String[] args) throws Exception {
  ...
  /**
   * Returns an XQFTTS error message.
   * @param name test name
   * @param error XQFTTS error
