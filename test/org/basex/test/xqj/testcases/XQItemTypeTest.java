...
public class XQItemTypeTest extends XQJTestCase {
  ...
  private void testSimpleType(XQItemType xqtype, int itemKind)
      throws XQException {
    try {
      xqtype.getBaseType();
    ...
    assertEquals("A-XQIT-2.1: getItemKind() returns the correct item kind.",
        itemKind, xqtype.getItemKind());
    assertEquals("A-XQIT-3.1: getItemOccurrence() returns OCC_EXACTLY_ONE.",
        XQSequenceType.OCC_EXACTLY_ONE, xqtype.getItemOccurrence());
    ...
    assertEquals("A-XQIT-6.2: getSchemaURI() returns null.", null, xqtype
        .getSchemaURI());
    try {
      xqtype.getTypeName();
    ...
    assertFalse(
        "A-XQIT-8.1: isAnonymousType() reports if the type is anonymous.",
        xqtype.isAnonymousType());
    assertFalse(
        "A-XQIT-9.1: isElementNillable() reports if the element is nillable.",
        xqtype.isElementNillable());
    try {
      xqtype.getPIName();
  ...
  public void testItemKindAtomic() throws XQException {
    ...
    assertEquals("A-XQIT-1.1: getBaseType() returns the correct base type.",
    ...
    assertEquals("A-XQIT-6.2: getSchemaURI() returns null.", null, xqtype
        .getSchemaURI());
    assertEquals("A-XQIT-7.1: getTypeName() returns the correct QName.",
        "string", xqtype.getTypeName().getLocalPart());
    assertEquals("A-XQIT-7.1: getTypeName() returns the correct QName.",
  ...
  public void testItemKindAttribute() throws XQException {
    XQItemType xqtype = xqc.createAttributeType(new QName("http://www.xqj.org",
        "a"), XQItemType.XQBASETYPE_STRING);
    ...
    // Not much we can test for toString()
    xqtype.toString();
    assertEquals("A-XQIT-5.1: getNodeName() returns the correct QName.", "a",
        xqtype.getNodeName().getLocalPart());
    assertEquals("A-XQIT-5.1: getNodeName() returns the correct QName.",
        "http://www.xqj.org", xqtype.getNodeName().getNamespaceURI());
    assertEquals("A-XQIT-6.2: getSchemaURI() returns null.", null, xqtype
        .getSchemaURI());
    assertEquals("A-XQIT-7.1: getTypeName() returns the correct QName.",
        "string", xqtype.getTypeName().getLocalPart());
  ...
  public void testItemKindDocumentElement() throws XQException {
    XQItemType xqtype_element = xqc.createElementType(new QName(
        "http://www.xqj.org", "e"), XQItemType.XQBASETYPE_STRING);
    ...
    // Not much we can test for toString()
    xqtype.toString();
    assertEquals("A-XQIT-5.1: getNodeName() returns the correct QName.", "e",
        xqtype.getNodeName().getLocalPart());
    assertEquals("A-XQIT-5.1: getNodeName() returns the correct QName.",
        "http://www.xqj.org", xqtype.getNodeName().getNamespaceURI());
    assertEquals("A-XQIT-6.2: getSchemaURI() returns null", null, xqtype
  ...
  public void testItemKindElement() throws XQException {
    XQItemType xqtype = xqc.createElementType(new QName("http://www.xqj.org",
        "e"), XQItemType.XQBASETYPE_STRING);
  ...
  public void testItemKindPI() throws XQException {
    ...
    assertFalse(
        "A-XQIT-9.1: isElementNillable() reports if the element is nillable.",
        xqtype.isElementNillable());
    assertEquals("A-XQIT-10.1: getPIName() returns the correct name.", "pi",
        xqtype.getPIName());
  }
