...
public class NodePrimitivesContainer implements NodePrimitives {
  ...
  private List<UpdatePrimitive> primitives = new LinkedList<UpdatePrimitive>();

  @Override
  public void add(UpdatePrimitive p) throws QueryException {
    add(findPos(p), p);
  }
  ...
  @Override
  public UpdatePrimitive findSpecific(PrimitiveType t) {
