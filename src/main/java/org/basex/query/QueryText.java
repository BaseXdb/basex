...
public interface QueryText {
  ...
  /** XPST0003: Parsing exception. */
  Object[] ORDERBY = { XPST, 3, "Expecting valid expression after 'order by'."};
  /** XPST0003: Parsing exception. */
  ...
  Object[] UPNSCONFL2 = { XUDY, 24, "New namespaces conflict with each other."};
