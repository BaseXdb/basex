...
public final class MainProp extends AProp {
  ...
  /** Server: port, used for binding the server to a SSL connection. */
  public static final Object[] SSLSERVERPORT = { "SSLSERVERPORT", 1988 };
  ...
  /** Server: SSL keystore. */
  public static final Object[] KEYSTORE = { "KEYSTORE", "etc/keystore" };
  /** Server: SSL keystore password. */
  public static final Object[] KEYPASSWORD = { "KEYSTOREPASSWORD", "" };
  /** Server: SSL keystore. */
  public static final Object[] TRUSTSTORE = { "TRUSTSTORE", "etc/keystore" };
  /** Server: SSL keystore. */
