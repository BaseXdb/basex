...
public final class TreePrinter implements FSTraversal {
  ...
  /**
   * Prints a line for tree(1)-like output of a directory. The line contains an
   * indentation prefix and the name of the directory and is printed whenever a
   * directory is entered during a filesystem traversal.
   */
  @Override
  ...
  /**
   * Prints a line for tree(1)-like output of a regular file. The line contains
   * an indentation prefix and the name of the file. It is printed whenever a
   * regular file is visited during a filesystem traversal.
   */
  @Override
  ...
  /**
   * Prints a line for tree(1)-like output of a symbolic link. The line contains
   * an indentation prefix and the name of the link. It is printed whenever a
   * symbolic link is visited during a filesystem traversal. The traversal will
   * not follow the link.
   */
  @Override
  ...
  /**
   * Nothing special is done when the traversal is finished. This method
   * contains no code.
   */
  @Override
