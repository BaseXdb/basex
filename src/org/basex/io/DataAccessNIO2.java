 ...
 *
 * NIO2: Use one MappedByteBuffer. Instead of reading a block from disk,
 ...
 */
public final class DataAccessNIO2 {
   ...
   */
  public DataAccessNIO2(final String db, final String fn) throws IOException {
   ...
   * @throws IOException IO Exception
   */
  public DataAccessNIO2(final String f) throws IOException {
    this(new File(f));
  }
   ...
   * @throws IOException IO Exception
   */
  public DataAccessNIO2(final File f) throws IOException {
