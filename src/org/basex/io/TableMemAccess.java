...
public final class TableMemAccess extends TableAccess {
  ...
  public TableMemAccess(final String db, final String fn, final int size)
    ...
    final RandomAccessFile f = new RandomAccessFile(
        IOConstants.dbfile(db, fn), "r");
