 ...
 */
public final class DataAccessNIO4 {
  ...
  private ByteBuffer bytebuffernio;
  /** Positions. */
   ...
   */
  public DataAccessNIO4(final String db, final String fn) throws IOException {
   ...
   * @throws IOException IO Exception
   */
  public DataAccessNIO4(final String f) throws IOException {
    this(new File(f));
  }
   ...
   * @throws IOException IO Exception
   */
  public DataAccessNIO4(final File f) throws IOException {
    file = new RandomAccessFile(f, "rw");
    fc = file.getChannel();
    bytebuffernio = ByteBuffer.allocateDirect(IO.BLOCKSIZE);
