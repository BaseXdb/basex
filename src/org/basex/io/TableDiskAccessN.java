 ...
 */
public final class TableDiskAccessN extends TableAccess {
   ...
   */
  public TableDiskAccessN(final String nm, final String f) throws IOException {
    db = nm;
    fn = f;
  ...
  private synchronized void readBlock(final int ind, final int first,
    ...
    try {
      ...
      mbb = fc.map(FileChannel.MapMode.READ_WRITE, b * IO.BLOCKSIZE,
          IO.BLOCKSIZE);
  ...
  public synchronized long read5(final int pos, final int off) {
    final int o = off + cursor(pos);
    return ((long) (mbb.get(o) & 0xFF) << 32)
        + ((long) (mbb.get(o + 1) & 0xFF) << 24)
        + ((mbb.get(o + 2) & 0xFF) << 16)
        + ((mbb.get(o + 3) & 0xFF) << 8) 
        + (mbb.get(o + 4) & 0xFF);
  }
  ...
  public synchronized void write4(final int pos, final int off, final int v) {
    final int o = off + cursor(pos);
    mbb.put(o, (byte) (v >>> 24));
    mbb.put(o + 1, (byte) (v >>> 16));
    mbb.put(o + 2, (byte) (v >>> 8));
    mbb.put(o + 3, (byte) v);
  }
  ...
  public synchronized void write5(final int pos, final int off, final long v) {
    final int o = off + cursor(pos);
    mbb.put(o, (byte) (v >>> 32));
    mbb.put(o + 1, (byte) (v >>> 24));
    mbb.put(o + 2, (byte) (v >>> 16));
    mbb.put(o + 3, (byte) (v >>> 8));
    mbb.put(o + 4, (byte) v);
  }
  ...
  public synchronized void delete(final int first, final int nr) {
    ...
    if(last < nextPre) {
      copy(mbb, from + nr, mbb, from, nextPre - last - 1);
