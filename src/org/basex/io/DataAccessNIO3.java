 ...
 */
public final class DataAccessNIO3 {
   ...
   */
  public DataAccessNIO3(final String db, final String fn) throws IOException {
   ...
   * @throws IOException IO Exception
   */
  public DataAccessNIO3(final String f) throws IOException {
    this(new File(f));
  }
   ...
   * @throws IOException IO Exception
   */
  public DataAccessNIO3(final File f) throws IOException {
    file = new RandomAccessFile(f, "rw");
    fc = file.getChannel();
    fc.position(0);
    bbuffer = ByteBuffer.allocate(IO.BLOCKSIZE);
    fc.read(bbuffer);
    buffer[0] = bbuffer.array();
    bbuffer.clear();
