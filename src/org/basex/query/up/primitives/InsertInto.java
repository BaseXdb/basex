 ...
 */
public final class InsertInto extends InsertPrimitive {
  /**
   * Constructor.
   * @param n target node
   ...
   */
  public InsertInto(final Nod n, final Iter copy, final int l) {
    super(n, copy, l);
  }
  ...
  public void apply(final int add) {
    ...
    if(d.parent(l, d.kind(l)) == d.parent(pos, d.kind(pos)) && 
        mergeText(d, pos - 1, pos)) return;
    final int r = pos + m.size(0, m.kind(0));
    if(r < d.meta.size && d.parent(r, d.kind(r)) == 
      d.parent(r - 1, d.kind(r - 1))) mergeText(d, r, r - 1);
  }
