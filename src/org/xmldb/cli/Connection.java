...
public interface Connection {
   ...
   /**
    * setDefaultLanguage sets the default language to be used by this
    * Connection.  Languages are considered features, so a developer may
    * also check the Feature set for a specific version of a language.
    *
    * @param language The default language name
    * @throws NotSupportedException exception
    */   
    ...
    * @throws DBException exception
    */
   Container queryDOMWithLanguage(org.w3c.dom.Document query, String language)
     throws DBException;
