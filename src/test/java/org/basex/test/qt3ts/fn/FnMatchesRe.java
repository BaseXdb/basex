...
public class FnMatchesRe extends QT3TestSet {
  ...
  public void re00972() {
    final XQuery query = new XQuery(
      "(every $s in tokenize('', ',') satisfies matches($s, '^(?:(\\d*){0,2}a\\1)$')) and (every $s in tokenize('33a34', ',') satisfies not(matches($s, '^(?:(\\d){0,2}a\\1)$')))",
      ctx);
  ...
  public void re00973() {
    final XQuery query = new XQuery(
      "(every $s in tokenize('', ',') satisfies matches($s, '^(?:(\\d*){2,}a\\1)$')) and (every $s in tokenize('333a334', ',') satisfies not(matches($s, '^(?:(\\d*){2,}a\\1)$')))",
      ctx);
  ...
  public void re00974() {
    final XQuery query = new XQuery(
      "(every $s in tokenize('', ',') satisfies matches($s, '^(?:(\\d*){0,2}?a\\1)$')) and (every $s in tokenize('22a3', ',') satisfies not(matches($s, '^(?:(\\d*){0,2}?a\\1)$')))",
      ctx);
  ...
  public void re00975() {
    final XQuery query = new XQuery(
      "(every $s in tokenize('', ',') satisfies matches($s, '^(?:(\\d*){2,}?a\\1)$')) and (every $s in tokenize('22a3', ',') satisfies not(matches($s, '^(?:(\\d*){2,}?a\\1)$')))",
      ctx);
  ...
  public void re00976() {
    final XQuery query = new XQuery(
      "(every $s in tokenize('22a22z', ',') satisfies matches($s, '^(?:(\\d*){2,}?a\\1z)$')) and (every $s in tokenize('22a22', ',') satisfies not(matches($s, '^(?:(\\d*){2,}?a\\1z)$')))",
      ctx);
