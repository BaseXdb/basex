...
public final class FNNotTest extends QueryTest {
  ...
  static {
    ...
    queries = new Object[][] {
      ...
      { "fn-notint1args-2", bool(false),
        "fn:not(xs:int('-1873914410'))"},
      { "fn-notint1args-3", bool(false),
      ...
      { "fn-notsht1args-1", bool(false),
        "fn:not(xs:short('-32768'))"},
      { "fn-notsht1args-2", bool(false),
        "fn:not(xs:short('-5324'))"},
      { "fn-notsht1args-3", bool(false),
      ...
      { "fn-not-12", bool(false),
        "fn:not('true') != fn:not('true')"},
      { "fn-not-13", bool(false),
        "fn:not('true') < fn:not('true')"},
      { "fn-not-14", bool(true),
        "fn:not('true') <= fn:not('true')"},
      { "fn-not-15", bool(false),
        "fn:not('true') > fn:not('true')"},
      { "fn-not-16", bool(true),
        "fn:not('true') >= fn:not('true')"},
      { "fn-not-17", bool(false),
      ...
      { "K-NotFunc-2",
        "not(1, 2, 3, 4, 5, 6)"},
      { "K-NotFunc-3", bool(true),
        "not(false() and false())"},
      { "K-NotFunc-4", bool(true),
        "not(not(true()))"},
      { "K-NotFunc-5", bool(true),
        "not(false())"},
      { "K-NotFunc-6", bool(true),
        "not(0)"},
      { "K-NotFunc-7", bool(true),
        "not(())"},
      { "K-NotFunc-8", bool(true),
        "not(xs:anyURI(''))"},
      { "K-NotFunc-9", bool(true),
