...
public final class GeoTest extends SandboxTest {
  ...
  @Test public void dimension() {
    ...
    error("geo:dimension(text {'a'})", INVTYPE_X_X_X);
  ...
  @Test public void geometryType() {
    ...
    error("geo:geometryType(text {'srsName'})", INVTYPE_X_X_X);
  ...
  @Test public void srid() {
    ...
    error("geo:srid(text {'a'})", INVTYPE_X_X_X);
  ...
  @Test public void envelope() {
    ...
    error("geo:envelope(text {'a'})", INVTYPE_X_X_X);
  ...
  @Test public void asText() {
    ...
    error("geo:asText(text {'a'})", INVTYPE_X_X_X);
  ...
  @Test public void asBinary() {
    ...
    error("geo:asBinary(text {'a'})", INVTYPE_X_X_X);
  ...
  @Test public void isSimple() {
    ...
    error("geo:isSimple(text {'a'})", INVTYPE_X_X_X);
  ...
  @Test public void boundary() {
    ...
    error("geo:boundary(text {'a'})", INVTYPE_X_X_X);
  ...
  @Test public void within() {
    ...
    error("geo:within()", FUNCARITY_X_X_X);
    error("geo:within(" +
  ...
  @Test public void contains() {
    ...
    error("geo:contains()", FUNCARITY_X_X_X);
    error("geo:contains(" +
            "<gml:Point><gml:coordinates>1,1</gml:coordinates></gml:Point>, " +
  ...
  @Test public void overlaps() {
    ...
    error("geo:overlaps()", FUNCARITY_X_X_X);
  ...
  @Test public void relate() {
    ...
    error("geo:relate()", FUNCARITY_X_X_X);
    error("geo:relate(" +
  ...
  @Test public void distance() {
    ...
    error("geo:distance()", FUNCARITY_X_X_X);
    error("geo:distance(" +
  ...
  @Test public void buffer() {
    ...
    error("geo:buffer(xs:double(1))", FUNCARITY_X_X_X);
  }
  ...
  @Test public void convexHull() {
    ...
    error("geo:convexHull(<gml:LinearRing><gml:coordinates>1,1 55,99 1,1" +
            "</gml:coordinates></gml:LinearRing>)", GeoErrors.qname(2));
    error("geo:convexHull()", FUNCARITY_X_X_X);
  ...
  @Test public void x() {
    ...
    error("geo:x(<gml:geo><gml:coordinates>2,1</gml:coordinates></gml:geo>)",
        GeoErrors.qname(1));
    error("geo:x(text {'a'})", INVTYPE_X_X_X);
  }
  ...
  @Test public void startPoint() {
    ...
    error("geo:startPoint(" +
            ...
            GeoErrors.qname(2));
    error("geo:startPoint()", FUNCARITY_X_X_X);
    error("geo:startPoint(text {'gml:Point'})", INVTYPE_X_X_X);
  ...
  @Test public void endPoint() {
    ...
    error("geo:endPoint(" +
            "<gml:LineString><gml:coordinates>1,1</gml:coordinates></gml:LineString>)",
            GeoErrors.qname(2));
    error("geo:endPoint()", FUNCARITY_X_X_X);
    error("geo:endPoint(text {'gml:Point'})", INVTYPE_X_X_X);
  ...
  @Test public void isClosed() {
    ...
    error("geo:isClosed(" +
            "<gml:LineString><gml:coordinates>1,1</gml:coordinates></gml:LineString>)",
            GeoErrors.qname(2));
    error("geo:isClosed()", FUNCARITY_X_X_X);
    error("geo:isClosed(text {'gml:Point'})", INVTYPE_X_X_X);
    error("geo:isClosed(" +
  ...
  @Test public void isRing() {
    ...
    error("geo:isRing(" +
            "<gml:LineString><gml:coordinates>1,1</gml:coordinates></gml:LineString>)",
            GeoErrors.qname(2));
    error("geo:isRing()", FUNCARITY_X_X_X);
    error("geo:isRing(text {'gml:Point'})", INVTYPE_X_X_X);
  ...
  @Test public void numPoints() {
    ...
    error("geo:numPoints(<gml:LineString><gml:coordinates>1,1</gml:coordinates>" +
            "</gml:LineString>)", GeoErrors.qname(2));
    error("geo:numPoints()", FUNCARITY_X_X_X);
    error("geo:numPoints(text {'gml:Point'})", INVTYPE_X_X_X);
  ...
  @Test public void pointN() {
    ...
    error("geo:pointN(text {'a'},3)", INVTYPE_X_X_X);
  }
  ...
  @Test public void area() {
    ...
    error("geo:area(<gml:LinearRing><gml:coordinates>0,0 0,20 0,0" +
            "</gml:coordinates></gml:LinearRing>)", GeoErrors.qname(2));
    error("geo:area()", FUNCARITY_X_X_X);
  ...
  @Test public void centroid() {
    ...
    error("geo:centroid(" +
            "<gml:unknown><gml:coordinates>1,1</gml:coordinates></gml:unknown>)",
            GeoErrors.qname(1));
    error("geo:centroid()", FUNCARITY_X_X_X);
    error("geo:centroid(text {'a'})", INVTYPE_X_X_X);
  }
  ...
  @Test public void pointOnSurface() {
    ...
    error("geo:pointOnSurface()", FUNCARITY_X_X_X);
    error("geo:pointOnSurface(text {'a'})", INVTYPE_X_X_X);
  }
  ...
  @Test public void exteriorRing() {
    ...
    error("geo:exteriorRing(" +
            "<gml:unknown><gml:coordinates>1,1</gml:coordinates></gml:unknown>)",
            GeoErrors.qname(1));
    error("geo:exteriorRing()", FUNCARITY_X_X_X);
    error("geo:exteriorRing(text {'a'})", INVTYPE_X_X_X);
  }
  ...
  @Test public void numInteriorRing() {
    ...
    error("geo:numInteriorRing()", FUNCARITY_X_X_X);
    error("geo:numInteriorRing(text {'a'})", INVTYPE_X_X_X);
  }
  ...
  @Test public void interiorRingN() {
    ...
    error("geo:interiorRingN(text {'<gml:Polygon/'}, 1)", INVTYPE_X_X_X);
    error("geo:interiorRingN()", FUNCARITY_X_X_X);
  }
