...
public final class GeoTest extends AdvancedQueryTest {
  ...
  public void dimension() {
    ...
    error("geo:dimension(text {'a'})", FUNTYPE.qname());
  ...
  public void geometryType() {
    ...
    error("geo:geometryType(text {'srsName'})", FUNTYPE.qname());
  ...
  public void srid() {
    ...
    error("geo:srid(text {'a'})", FUNTYPE.qname());
  ...
  public void envelope() {
    ...
    error("geo:envelope(text {'a'})", FUNTYPE.qname());
  ...
  public void asText() {
    ...
    error("geo:asText(text {'a'})", FUNTYPE.qname());
  ...
  public void asBinary() {
    ...
    error("geo:asBinary(text {'a'})", FUNTYPE.qname());
  ...
  public void isSimple() {
    ...
    error("geo:isSimple(text {'a'})", FUNTYPE.qname());
  ...
  public void equals() {
    ...
    error("geo:equals(text {'a'}, a)", NOCTX.qname());
  ...
  public void disjoint() {
    ...
    error("geo:disjoint(a, text {'a'})", NOCTX.qname());
  ...
  public void intersects() {
    ...
    error("geo:intersects(a, text {'a'})", NOCTX.qname());
  ...
  public void touches() {
    ...
    error("geo:touches(a, text {'a'})", NOCTX.qname());
  ...
  public void crosses() {
    ...
    error("geo:crosses(a, text {'a'})", NOCTX.qname());
  ...
  public void within() {
    ...
    error("geo:within()", FUNCARGS.qname());
    error("geo:within(" +
  ...
  public void contains() {
    ...
    error("geo:contains()", FUNCARGS.qname());
    error("geo:contains(" +
            "<gml:Point><gml:coordinates>1,1</gml:coordinates></gml:Point>, " +
  ...
  public void overlaps() {
    ...
    error("geo:overlaps()", FUNCARGS.qname());
  ...
  public void relate() {
    ...
    error("geo:relate(<gml:Point><gml:coordinates>18,11</gml:coordinates></gml:Point>,"
          + "<gml:LineString><gml:coordinates>11,10 20,1 20,20</gml:coordinates>" +
            "</gml:LineString>, \"0******\")", FUNTYPE.qname());

    error("geo:relate(" +
            "<gml:Point><gml:coordinates>18,11</gml:coordinates></gml:Point>," +
            "<gml:LineString><gml:coordinates>11,10 20,1 20,20</gml:coordinates>" +
            "</gml:LineString>, \"0*******12*F\")", FUNTYPE.qname());

    error("geo:relate()", FUNCARGS.qname());
    error("geo:relate(" +
  ...
  public void distance() {
    ...
    error("geo:distance()", FUNCARGS.qname());
    error("geo:distance(" +
  ...
  public void buffer() {
    ...
    error("geo:buffer(<gml:LinearRing><gml:coordinates>1,1 55,99 1,1" +
            "</gml:coordinates></gml:LinearRing>, 1)", FUNTYPE.qname());
    error("geo:buffer(xs:double(1))", FUNCARGS.qname());
  }
  ...
  public void convexHull() {
    ...
    error("geo:convexHull(<gml:LinearRing><gml:coordinates>1,1 55,99 1,1" +
            "</gml:coordinates></gml:LinearRing>)", GeoErrors.qname(2));
    error("geo:convexHull()", FUNCARGS.qname());
  ...
  public void x() {
    ...
    error("geo:x(<gml:geo><gml:coordinates>2,1</gml:coordinates></gml:geo>)",
        GeoErrors.qname(1));
    error("geo:x(text {'a'})", FUNTYPE.qname());
  }
  ...
  public void startPoint() {
    ...
    error("geo:startPoint(" +
            ...
            GeoErrors.qname(2));
    error("geo:startPoint()", FUNCARGS.qname());
    error("geo:startPoint(text {'gml:Point'})", FUNTYPE.qname());
  ...
  public void endPoint() {
    ...
    error("geo:endPoint(" +
            "<gml:LineString><gml:coordinates>1,1</gml:coordinates></gml:LineString>)",
            GeoErrors.qname(2));
    error("geo:endPoint()", FUNCARGS.qname());
    error("geo:endPoint(text {'gml:Point'})", FUNTYPE.qname());
  ...
  public void isClosed() {
    ...
    error("geo:isClosed(" +
            "<gml:LineString><gml:coordinates>1,1</gml:coordinates></gml:LineString>)",
            GeoErrors.qname(2));
    error("geo:isClosed()", FUNCARGS.qname());
    error("geo:isClosed(text {'gml:Point'})", FUNTYPE.qname());
    error("geo:isClosed(" +
  ...
  public void isRing() {
    ...
    error("geo:isRing(" +
            "<gml:LineString><gml:coordinates>1,1</gml:coordinates></gml:LineString>)",
            GeoErrors.qname(2));
    error("geo:isRing()", FUNCARGS.qname());
    error("geo:isRing(text {'gml:Point'})", FUNTYPE.qname());
  ...
  public void numPoints() {
    ...
    error("geo:numPoints(<gml:LineString><gml:coordinates>1,1</gml:coordinates>" +
            "</gml:LineString>)", GeoErrors.qname(2));
    error("geo:numPoints()", FUNCARGS.qname());
    error("geo:numPoints(text {'gml:Point'})", FUNTYPE.qname());
  ...
  public void pointN() {
    ...
    error("geo:pointN(text {'a'},3)", FUNTYPE.qname());
  }
  ...
  public void centroid() {
    ...
    error("geo:centroid(" +
            "<gml:unknown><gml:coordinates>1,1</gml:coordinates></gml:unknown>)",
            GeoErrors.qname(1));
    error("geo:centroid()", FUNCARGS.qname());
    error("geo:centroid(text {'a'})", FUNTYPE.qname());
  }
  ...
  public void pointOnSurface() {
    ...
    error("geo:pointOnSurface()", FUNCARGS.qname());
    error("geo:pointOnSurface(text {'a'})", FUNTYPE.qname());
  }
  ...
  public void exteriorRing() {
    ...
    error("geo:exteriorRing(" +
            "<gml:unknown><gml:coordinates>1,1</gml:coordinates></gml:unknown>)",
            GeoErrors.qname(1));
    error("geo:exteriorRing()", FUNCARGS.qname());
    error("geo:exteriorRing(text {'a'})", FUNTYPE.qname());
  }
  ...
  public void numInteriorRing() {
    ...
    error("geo:numInteriorRing()", FUNCARGS.qname());
    error("geo:numInteriorRing(text {'a'})", FUNTYPE.qname());
  }
  ...
  public void interiorRingN() {
    ...
    error("geo:interiorRingN(text {'<gml:Polygon/'}, 1)", FUNTYPE.qname());
    error("geo:interiorRingN()", FUNCARGS.qname());
  }
